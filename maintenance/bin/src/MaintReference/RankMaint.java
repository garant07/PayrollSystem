 ...
 * Program: Rank Maintenance ==-> Payroll System
 */
...
public class RankMaint extends JInternalFrame {

	private static final long serialVersionUID = 1L;
	static final String DEFAULT_QUERY = DBConnect.Select("rank",
														 "rank_code, rank_desc",
														 null,
														 "rank_code ASC");
	...
	public RankMaint(){
		super ("Rank Maintenance", false, true, false, false);
		this.setName("rank");
			...
			jbtnadd.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent e){
					...
					if (caption == "Add"){
						...
						String save_sql = DBConnect.Insert("rank",
								"rank_code,rank_desc",
								"'"+DBConnect.clean(xcode)+"','"+DBConnect.clean(xdesc)+"'");
						//String save_sql = "Insert into rank (rank.code,rank.desc,rank.authority) values ('"+xcode+"','"+xdesc+"','"+xauth+"')";
						tbl.setEnabled(false);
						...
						SwingUtilities.invokeLater(new Runnable(){
							...
							public void run() {
								try {
									...
									("rank","*","rank_code = '" + DBConnect.clean(code) +"'");
									LockHandler.startLock(lockCmd);

									String del_sql = DBConnect.delete("rank",
											"rank_code = '"+DBConnect.clean(xcode)+"'");
									//String del_sql = "Delete from rank where code = '"+xcode+"'";
				...
				public void actionPerformed(ActionEvent e){
					...
					if (ucode.length() != 0){
						if (ecaption == "Edit"){
							...
							try{
								String e_sql = DBConnect.Update("rank",
										"rank_desc='"+DBConnect.clean(udesc)+"'",
										"rank_code= '"+DBConnect.clean(ucode)+"'");
		...
		catch ( ClassNotFoundException classNotFound ) 
		{
			...
			createINI.create("RankMaint", "RankMaint", traceWriter.toString());      
			dispose();
		}
